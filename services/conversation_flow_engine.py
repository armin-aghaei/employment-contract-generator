...
- If the template configuration has a "systemPrompt" field that says to include ALL questions, you MUST extract EVERY question defined
- Process ALL phases and ALL sections in order
- Do NOT skip or summarize questions - include each question exactly as defined
- Your question_sequence should be comprehensive and complete
